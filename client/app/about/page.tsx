    ...
    <div className="pt-20">
      <section className="relative h-96 flex items-center justify-center text-white mb-16">
        <div className="absolute inset-0 z-0">
          <Image src="https://res.cloudinary.com/dvkmzugpb/image/upload/v1757518633/mh4wcmrhr6j6spblaj1i_ok2wja.jpg" alt="About DreamWayHolidays" fill className="object-cover" />
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
            ...
            <div className="relative">
              <div className="relative h-80 lg:h-96 rounded-2xl overflow-hidden shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-500">
                <Image src="https://res.cloudinary.com/dvkmzugpb/image/upload/v1757518644/n3uios9arikjogsfuqs0_it00jt.jpg" alt="Spiritual journey" fill className="object-cover" />
              </div>
        ...
        <section className="bg-white rounded-3xl p-12 lg:p-16 mb-16 shadow-xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="relative lg:order-1">
              <div className="relative h-80 lg:h-96 rounded-2xl overflow-hidden shadow-2xl transform -rotate-3 hover:rotate-0 transition-transform duration-500">
                <Image src="https://res.cloudinary.com/dvkmzugpb/image/upload/v1757518620/avkwjbbyabxkynmqghvm_cjwuto.jpg" alt="Adventure trekking" fill className="object-cover" />
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
            ...
            <div className="relative">
              <div className="relative h-80 lg:h-96 rounded-2xl overflow-hidden shadow-2xl transform rotate-2 hover:rotate-0 transition-transform duration-500">
                <Image
                  src="https://res.cloudinary.com/dvkmzugpb/image/upload/v1757518682/happy-travelers-indian-guide_j8hdth_kms0hr.png"
        ...
        <section className="bg-white rounded-3xl p-12 lg:p-16 mb-16 shadow-xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="relative lg:order-1">
              <div className="relative h-80 lg:h-96 rounded-2xl overflow-hidden shadow-2xl transform -rotate-2 hover:rotate-0 transition-transform duration-500">
                <Image src="https://res.cloudinary.com/dvkmzugpb/image/upload/v1757518622/k4dkwobfnpkxxikrwct4_m1zibh.jpg" alt="Beautiful Mountains" fill className="object-cover" />
              </div>
